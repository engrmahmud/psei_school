...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'admin_model.dart' as _i5;
...
class Protocol extends _i1.SerializationManagerServer {
    ...
    _i2.TableDefinition(
      ...
      columns: [
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'int?',
          columnDefault: 'nextval(\'student_course_id_seq\'::regclass)',
        ),
        _i2.ColumnDefinition(
          name: 'studentId',
          columnType: _i2.ColumnType.bigint,
    ...
    _i2.TableDefinition(
      ...
      columns: [
        _i2.ColumnDefinition(
          ...
          isNullable: false,
          dartType: 'int?',
          columnDefault: 'nextval(\'teacher_id_seq\'::regclass)',
        ),
        _i2.ColumnDefinition(
          name: 'teacherName',
          columnType: _i2.ColumnType.text,
  ...
  T deserialize<T>(
    ...
    if (t == _i7.StudentCourse) {
      return _i7.StudentCourse.fromJson(data) as T;
    }
    if (t == _i8.Student) {
    ...
    if (t == _i1.getType<_i7.StudentCourse?>()) {
      return (data != null ? _i7.StudentCourse.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'StudentCourse') {
      return deserialize<_i7.StudentCourse>(data['data']);
    }
  ...
  @override
  String getModuleName() => 'psei_school';
