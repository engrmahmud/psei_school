...
import 'teacher_model.dart' as _i6;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i6.Teacher) {
      return _i6.Teacher.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i6.Teacher?>()) {
      return (data != null ? _i6.Teacher.fromJson(data) : null) as T;
    }
    if (t == List<_i7.Student>) {
      return (data as List).map((e) => deserialize<_i7.Student>(e)).toList()
          as T;
    }
    if (t == List<_i8.Teacher>) {
      return (data as List).map((e) => deserialize<_i8.Teacher>(e)).toList()
          as T;
    }
    try {
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'Teacher') {
      return deserialize<_i6.Teacher>(data['data']);
    }
