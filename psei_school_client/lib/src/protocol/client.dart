...
class EndpointAuth extends _i2.EndpointRef {
  ...
  _i3.Future<_i5.Admin?> verifyAdmin(
    String email,
    String password,
  ) => caller.callServerEndpoint<_i5.Admin?>(
    'auth',
    'verifyAdmin',
    {
      'email': email,
...
class EndpointStudentEndpoints extends _i2.EndpointRef {
  ...
  _i3.Future<bool> deleteStudentById(int id) => caller.callServerEndpoint<bool>(
    'studentEndpoints',
    'deleteStudentById',
    {'id': id},
  );
...
/// {@category Endpoint}
class EndpointTeacherEndpoints extends _i2.EndpointRef {
  EndpointTeacherEndpoints(_i2.EndpointCaller caller) : super(caller);
  ...
  _i3.Future<bool> deleteTeacherById(int id) => caller.callServerEndpoint<bool>(
    'teacherEndpoints',
    'deleteTeacherById',
    {'id': id},
  );
